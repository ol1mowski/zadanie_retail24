...
export const ExportLinkButton: React.FC<ExportLinkButtonProps> = ({
  ...
  return (
    <button
      onClick={handleShare}
      className={`px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors duration-200 text-sm font-medium flex items-center gap-2 ${className}`}
      title="Udostępnij stoper"
    >
      <svg
        className="w-4 h-4"
        fill="none"
